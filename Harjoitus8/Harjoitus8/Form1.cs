...
namespace Harjoitus8
{
    public partial class Form1 : Form
    {
        ...
        private void MuutaBT_Click(object sender, EventArgs e)
        {
            ...
            {
                luku1 = Convert.ToInt32(NumeroTB.Text.Substring(0,1)); //tuhat
                luku2 = Convert.ToInt32(NumeroTB.Text.Substring(1, 1)); //sata
                luku3 = Convert.ToInt32(NumeroTB.Text.Substring(2, 1)); //kymmenen
                luku4 = Convert.ToInt32(NumeroTB.Text.Substring(3, 1)); //yksi
                if (luku1 % 3 == 0)
                {
                    vastaus += "MMM";
                }
            ...
            else if ( NumeroTB.Text.Length > 0)
            {
